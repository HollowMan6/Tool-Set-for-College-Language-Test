...
This is a Download and Mark Inquiry Tool Coded Using Python Tkinter to Batch Download CET Admission Ticket（CET准考证批量下载，成绩查询工具）

***新*** : 2019.8.21 新增成绩查询工具（无验证码状态）（在2019.8.21 9：00-15：00（UTC+8）时使用亲测成功。）

[Win程序(准考证下载):](Download-Tools-for-CET-Admission-Ticket.exe) 

![](screenshoot.JPG) 

[Win程序(无验证码成绩查询):](Inquire-Mark-Tool-for-CET.exe) 
...
[无验证码成绩查询脚本](Inquire-Mark-Tool-for-CET.py)
...
例：你抓包获得的地址是**http://47.94.127.138/cet/query?data=xxxxxxxxxxxx** , 则在界面中输入**http://47.94.127.138/cet/query?data**
...
[Windows Program(Ticket Download Tool)](Download-Tools-for-CET-Admission-Ticket.exe)

[Windows Program(Mark Inquiry without Captcha):](Inquire-Mark-Tool-for-CET.exe) 
...
[Mark Inquiry without Captcha Script](Inquire-Mark-Tool-for-CET.py)
...
eg.: The address you get by grabbing the package is **http://47.94.127.138/cet/query? Data = xxxxxxxxxxxxxxxxxx**, then enter **http://47.94.127.138/cet/query data** in the interface.
